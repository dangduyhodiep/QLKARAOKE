USE [master]
GO
/****** Object:  Database [QLYKARAOKE]    Script Date: 14/10/2023 7:47:19 SA ******/
...
USE [QLYKARAOKE]
GO
/****** Object:  Table [dbo].[id]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tb_bienlai]    Script Date: 14/10/2023 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_dichvu]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_hdtp]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_hoadondv]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_khachhang]    Script Date: 16/10/2023 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_khachnhanphong]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_login]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_nhanvien]    Script Date: 16/10/2023 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tb_phong]    Script Date: 16/12/2017 7:47:19 SA ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[tb_dichvu] ([ma_dv], [ten_dv], [gia_dv]) VALUES (4, N'bò húc', 18000)
...
INSERT [dbo].[tb_khachhang] ([ma_kh], [ten_kh], [cmnd_kh], [quoctich_kh], [gioitinh_kh], [tuoi_kh], [sdt_kh], [tinhtrang]) VALUES (1, N'diep Ho', N'4203942', N'VIỆT NAM', N'0', N'18', N'20934820', N'1')
INSERT [dbo].[tb_khachnhanphong] ([ma_kh], [ma_phong]) VALUES (1, 3)
INSERT [dbo].[tb_khachnhanphong] ([ma_kh], [ma_phong]) VALUES (8, 2)
INSERT [dbo].[tb_login] ([ma_tk], [taikhoan], [matkhau], [ten_tk], [tinhtrang]) VALUES (1, N'admin', N'123', N'Đặng Duy Hồ Điệp', N'1')
INSERT [dbo].[tb_login] ([ma_tk], [taikhoan], [matkhau], [ten_tk], [tinhtrang]) VALUES (2, N'diep', N'1234', N'DiepKenDy', N'1')
INSERT [dbo].[tb_login] ([ma_tk], [taikhoan], [matkhau], [ten_tk], [tinhtrang]) VALUES (3, N'tai', N'1234', N'TaiNguyen', N'0')
INSERT [dbo].[tb_nhanvien] ([ma_nv], [ten_nv], [chucvu_nv], [luong_nv], [namsinh_nv], [gioitinh_nv], [chuthich_nv]) VALUES (1, N'Pham Khả Chinh', N'Quản Lí', N'5000000', N'2002', N'1', N'VIP')
INSERT [dbo].[tb_nhanvien] ([ma_nv], [ten_nv], [chucvu_nv], [luong_nv], [namsinh_nv], [gioitinh_nv], [chuthich_nv]) VALUES (2, N'Tan Tai', N'nhân viên', N'5000000', N'2002', N'1', N'')
INSERT [dbo].[tb_nhanvien] ([ma_nv], [ten_nv], [chucvu_nv], [luong_nv], [namsinh_nv], [gioitinh_nv], [chuthich_nv]) VALUES (3, N'Hồng Hạnh', N'nhân viên', N'5000000', N'1996', N'0', N'')
INSERT [dbo].[tb_nhanvien] ([ma_nv], [ten_nv], [chucvu_nv], [luong_nv], [namsinh_nv], [gioitinh_nv], [chuthich_nv]) VALUES (4, N'Thanh Long', N'nhân viên', N'4000000', N'2002', N'1', N'')
INSERT [dbo].[tb_nhanvien] ([ma_nv], [ten_nv], [chucvu_nv], [luong_nv], [namsinh_nv], [gioitinh_nv], [chuthich_nv]) VALUES (5, N'Đạt', N'nhân viên', N'4500000', N'1997', N'1', N'')
