...
//		txtngayht.setText("");
		...
		txtNewLabel_13.setBounds(13, 282, 55, 14);
		panel_1.add(txtNewLabel_13);
		
		txttongtien = new JTextField();
		txttongtien.setEditable(false);
		txttongtien.setBounds(104, 274, 139, 30);
...
/** 19/11/2023
	...
	btn_inhoadon.addMouseListener(new MouseAdapter() {
		@Override
		public void mouseClicked(MouseEvent e) {
			printComponenet(new ThanhToan());
			
		}
	});
	btn_inhoadon.setIcon(new ImageIcon("C:\\Users\\admin\\Desktop\\20054911\\DoAn_PTUD\\img\\printer.png"));
	btn_inhoadon.setFont(new Font("Tahoma", Font.PLAIN, 16));
	btn_inhoadon.setBounds(304, 589, 174, 39);
	Container panel = null;
	panel.add(btn_inhoadon);
	
	JScrollPane scrollPane = new JScrollPane();
	scrollPane.setBounds(522, 84, 1008, 688);
	Container container = new Container();
	container.add(scrollPane);
	
	JTable table_thongtinhoadon = new JTable();
	table_thongtinhoadon.setModel(new DefaultTableModel(
		new Object[][] {
			{null, null, null, null, null, null},
		},
		new String[] {
			"M\u00E3 h\u00F3a \u0111\u01A1n", "M\u00E3 kh\u00E1ch h\u00E0ng", "M\u00E3 ph\u00F2ng", "Gi\u1EDD v\u00E0o", "Gi\u1EDD ra", "T\u1ED5ng ti\u1EC1n"
		}
	));
	scrollPane.setViewportView(table_thongtinhoadon);
	
	JLabel lblNewLabel = new JLabel("Thanh to\u00E1n");
	lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 50));
	lblNewLabel.setBounds(10, 0, 507, 74);
	Container container2 = new Container();
	container2.add(lblNewLabel);
...
//	      g2.translate(pf.getImageableX(), pf.getImageableY());//lay vi tri cua X cua file pfd va vi tri y cuar file pdf sau do ap len panel kho vai shit
//	      Giả sử g2d bắt đầu từ (0,0) và pf bắt đầu từ (100,100), 
//	      sau khi dịch, điểm của g2d (0,100) bây giờ sẽ ở mức (100,200), 
//	      đó là điểm của pf (0,100) vì nó không bắt đầu ở cùng một nơi.
//	      
